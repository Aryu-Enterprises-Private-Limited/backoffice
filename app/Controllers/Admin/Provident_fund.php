...
class Provident_fund extends BaseController
{
    ...
    public function list_ajax($returnType = 'json')
    {
        ...
        foreach ($ajaxDataArr->getResult() as $row) {
            ...
            $actionTxt .= '<a href="javascript:void(0);" class="delconfirm btn btn-icon text-danger" data-row_id="' . $rowId . '" data-act_url="/' . ADMIN_PATH . '/pf/delete"><i class="fas fa-trash-alt"></i></a>';
