...
class Employee extends BaseController
{
    ...
    {
        $condition2 = array('is_deleted' => '0', 'employment_type' => 'full_time');
        $fulltime_cnt = $this->LmsModel->get_all_counts(EMPLOYEE_DETAILS, $condition2);

        $condition3 = array('is_deleted' => '0', 'employment_type' => 'freelance');
        $free_cnt = $this->LmsModel->get_all_counts(EMPLOYEE_DETAILS, $condition3);

        $condition4 = array('is_deleted' => '0', 'employment_type' => 'intern');
