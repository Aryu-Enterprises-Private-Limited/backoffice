                ...
                <form autocomplete="off">
                    <div class="col-lg-5 float-start m-filter me-1">
                        ...
                        <select name="status" id="employee_sts" class=" form-control">
                            ...
                            <option value="0" >Relieved Employee</option>
                        </select>
                    </div>
...
<div class="modal" tabindex="-1" id="show_income_modal">
...
<script>
    $(function() {
        ...
        // if (qryString != '') {
        //     var url = "<?php echo base_url(); ?>manager/income/list_ajax?" + qryString;
        // } else {
        //     var url = "<?php echo base_url(); ?>manager/income/list_ajax";
        // }
        var url = "<?php echo base_url(); ?>manager/income/list_ajax";
        ...
        const myModal = new bootstrap.Modal('#show_income_modal');

        $('body').on("click", ".details_btn", function() {
            // myModal.show();
            $('#show_data').html('');
