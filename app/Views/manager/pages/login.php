        ...
        <div class="card total-card">
            ...
            <div class="card-body">
                <div class="card log-card">
                    ...
                    <div class="mail-pass ">
                        <form id="login_form" method="post" action="<?= (base_url(MANAGER_PATH . '/do-login'))  ?>" autocomplete="off">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="row">
                                    <p class="text-center">Need An Account?<a href="<?= (base_url(MANAGER_PATH . '/register'))  ?>">Register</a></p>
                                </div>
