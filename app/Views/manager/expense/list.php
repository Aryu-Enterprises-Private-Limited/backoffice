...
<div class="modal" tabindex="-1" id="show_expense_modal">
...
<script>
    $(function() {
        ...
        // }
        var url = "<?php echo base_url(); ?>manager/expense/list_ajax";
        ...
        const myModal = new bootstrap.Modal('#show_expense_modal');
