...
<script>
    $(function() {
        $('body').on("change", ".reason_for_rej", function() {
            var row_id = $(this).attr('data-row_id');
            var selected_val = $('.reason_for_rej option:selected').val();
            var act_url = '<?php echo base_url(); ?>admin/candidates/update_reson_rej';
            $.ajax({
                type: 'post',
                url: act_url,
                data: {
                    'reason_rejection_id': selected_val,
                    'candidate_id': row_id,
                },
                dataType: 'json',
        ...
        $('body').on("change", ".interviewer_id", function() {
            var row_id = $(this).attr('data-row_id');
            var selected_val = $('.interviewer_id option:selected').val();
            var act_url = '<?php echo base_url(); ?>admin/candidates/update_interviewer';
            $.ajax({
                type: 'post',
                url: act_url,
                data: {
                    'interviewer': selected_val,
                    'candidate_id': row_id,
                },
                dataType: 'json',
                success: function(res) {
