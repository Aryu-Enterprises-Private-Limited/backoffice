        ...
        <div class="card-body">
            ...
            <div class="create-label">
                <form id="candidates_form" method="post" action="<?= (base_url(ADMIN_PATH . '/candidates/update'))  ?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select form-control create-input" name="application_status_id" id="application_status_id" required>
                                ...
                                ?>
                                    <option value="<?php echo $value->id; ?>,<?php echo $value->app_status; ?>" <?= $selected; ?>>
                    ...
                    <!-- <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label fw-bold"> Interviewer </label>
                        <div class="col-sm-10">
                            <select class="form-select form-control create-input" name="interviewer" id="interviewer">
                                <option value="">Select</option>
                                <option value="aruna" <?php if (isset($candidates_info->interviewer) && $candidates_info->interviewer == 'aruna') {
                                                            $sel = 'selected';
                                                        } else {
                                                            $sel = '';
                                                        }  ?><?= $sel; ?>>Aruna</option>
                                <option value="yuvaraj" <?php if (isset($candidates_info->interviewer) && $candidates_info->interviewer == 'yuvaraj') {
                                                            $sel = 'selected';
                                                        } else {
                                                            $sel = '';
                                                        }  ?><?= $sel; ?>>Yuvaraj</option>
                                <option value="hr" <?php if (isset($candidates_info->interviewer) && $candidates_info->interviewer == 'hr') {
                                                        $sel = 'selected';
                                                    } else {
                                                        $sel = '';
                                                    }  ?><?= $sel; ?>>HR</option>
