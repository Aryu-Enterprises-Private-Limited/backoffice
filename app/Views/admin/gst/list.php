    ...
    <div class="card create-box">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <a href="<?= (base_url(ADMIN_PATH . '/gst/add')); ?>">
...
<script>
    $(function() {
        ...
        if (qryString3 != '') {
            var url = "<?php echo base_url(); ?>admin/gst/list_ajax?" + qryString3;
        } else {
            var url = "<?php echo base_url(); ?>admin/gst/list_ajax";
        }
        ...
        $('body').on("click", ".btn-close", function() {
            ...
            var url = "<?php echo base_url(); ?>admin/gst/alert_close";
            $.ajax({
                type: 'post',
                url: url,
                data: {
        ...
        $('#FilterBtns3').on('click', function() {
            var qryString3 = get_filter_yearstrings();
            if (qryString3 != '') {
                window.location.href = "<?php echo base_url(); ?>admin/gst/list?" + qryString3;
            } else {
                window.location.href = "<?php echo base_url(); ?>admin/gst/list";
            }
        });
    });
</script>
