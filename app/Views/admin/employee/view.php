                ...
                <div class="col-md-11">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-decoration-none" href="<?= '/' . ADMIN_PATH . '/employee/list' ?>">Employee</a>
                        </li>
                ...
                <table class="table table-bordered m-b-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if (isset($empDetails->gender)) echo  ucfirst($empDetails->gender);   ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php if (isset($empDetails->employeeid)) echo ucfirst($empDetails->employeeid); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php if (isset($empDetails->employment_type)) echo  str_replace("_"," ",ucfirst($empDetails->employment_type));   ?></td>
                        </tr>
                        <tr>
