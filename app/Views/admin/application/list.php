    ...
    <div class="card create-box">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-1">
                    <a href="<?= (base_url(ADMIN_PATH . '/application/add')); ?>">
...
<script type="text/javascript" src="/plugins/datatable/js/dataTables.bootstrap5.min.js"></script>
...
<script>
    $(function() {
        var url = "<?php echo base_url(); ?>admin/application/list_ajax";
