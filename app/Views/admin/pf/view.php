            ...
            <div class="table-responsive">
                <table class="table table-bordered m-b-0">
                    <tbody>
                        ...
                        <?php 
                        $commaSeparated = $pf_details->pf_document;
                        ...
                        <tr>
                            ...
                            <?php if (isset($file) && $file != '') { ?>
                                <td><a target="_blank" href="<?php if (isset($file)) echo ('/' . ADMIN_PATH . '/pf/view_doc/' . (string)$file . '')  ?>" class="btn btn-info v_btn">View</td> </a>
                            <?php  } else { ?>
