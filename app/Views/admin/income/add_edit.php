            ...
            <div class="create-label">
                <form id="income_form" method="post" action="<?= (base_url(ADMIN_PATH . '/income/update'))  ?>" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control create-input" name="invoice_no" id="invoice_no" value="<?php if (isset($income_info->invoice_no)) echo $income_info->invoice_no; ?>" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control create-input" name="amount" id="amount" value="<?php if (isset($income_info->amount)) echo $income_info->amount; ?>" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
