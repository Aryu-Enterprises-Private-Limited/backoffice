                                ...
                                <tbody>
                                    ...
                                    if (!empty($att_details)) {
                                        ...
                                        foreach ($att_details as $item) {
                                            ...
                                            echo "<tr>";
                                            echo "<td> " . $s . "</td>";
                                            echo'<td><a href="/' . ADMIN_PATH . '/employee/view/' . $item->employee_id . '" class="text-decoration-none">'. ucfirst($item->employee_name).'</a><td>';
                                            ...
                                            if (is_array($dates)) {
                                                foreach ($dates as $dt) {
                                                    ...
                                                    if (in_array($dt, $att_dt)) {
                                                        ...
                                                        $total_hrs = sprintf("%02d:%02d", $hours, $minutes);
                                        ...
                                        foreach ($emp_details as $item) {
                                            echo "<tr>";
                                            echo "<td> " . $s . "</td>";
                                            echo '<td><a href="/' . ADMIN_PATH . '/employee/view/' . $item->employeeid . '" class="text-decoration-none">'. ucfirst($item->first_name).'</a><td>';
                                            if (is_array($dates)) {
                                                $att_dt = array();
                                                foreach ($dates as $dt) {
                                                    // print_r($att_dt);
