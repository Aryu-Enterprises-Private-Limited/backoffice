                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if (isset($crmDetails->document_name) && $crmDetails->document_name != '') { ?>
                                <td><a target="_blank" href="<?php if (isset($crmDetails->document_name)) echo ('/' . ADMIN_PATH . '/crm/view_doc/' . (string)$crmDetails->document_name . '')  ?>" class="btn btn-info v_btn">View</td> </a>
                            <?php  } else { ?>
